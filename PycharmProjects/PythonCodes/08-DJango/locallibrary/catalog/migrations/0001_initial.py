# Generated by Django 2.1.1 on 2018-11-20 05:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_death', models.CharField(blank=True, max_length=10, null=True, verbose_name='Died')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('m', 'Maintenance'), ('o', 'On loan'), ('a', 'Available'), ('r', 'Reverse')], default='m', help_text='Book availability', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text="Enter this book's natural language", max_length=200)),
            ],
        ),
        migrations.AddField(
            model_name='book',
